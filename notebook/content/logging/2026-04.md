...
小鹤
ubuntu2204
vscode, 用 user installer 装给 admin 了
clash
trae
utools
explorer patcher
...
```
sudo apt install -y build-essential libssl-dev libspdlog-dev cmake python3-colcon-common-extensions libopencv-dev python3-opencv
```
