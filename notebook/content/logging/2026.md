...
其实有两种改法, 一种是增加 locking 状态, 另一种是直接改变 LOST->INIT 的判定条件

- [ ] 最优选项计数增加: (单人在场内) || ((多人在场内 && 单人有球拍) || (多人有球拍 && 离中心最近))
- 所以需要知道的信息: 场内是否单人, 有无球拍, 离中心距离
- [ ] 原本的选择逻辑中 INIT 增加 nms 去重, 球场内判定
- [ ] INIT 状态下应该储存多个人体信息 -> 多个模型检测 roi 
    - [ ] candidate: 检测 roi, 人体 roi, 有球拍, 在场内, 离中心距离, 最优选项选计数
