...
- [x] 验收指标 ✅ 2026-05-06
- [ ] ransac 失败时降级拟合(只用 高 fit_prior_weights 的点)/放宽成功门槛(降低 min_inliers_to_accept/增大 inlier_thresh, 重跑, EstimateSim3Robust)
- [x] 骨长限制 s ✅ 2026-05-06
...
222 两边都还算稳定
344 也并不稳定
260 使 343 末尾没有移动, 但理论上, 这和自动分批的批次相近: 