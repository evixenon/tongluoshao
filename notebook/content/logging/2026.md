...
5p 先推代码 
- [x] 截10张图 ✅ 2026-05-29
- [x] court_detect 增加测试模式, 测试模式下保存10张相机图片和 top50 标定结果 ✅ 2026-05-29

下周, 检查工具 detect_lines(小数?传错线?), 增加横向线段角误差, 缩小直线检测范围

## week 12

- [ ] 可视化工具线段坐标截断问题: 1 上游生成线段的时候用了 cv::Point 而不是 2f. 2 获取线后未清空队列
- [x] 改进度条 ✅ 2026-06-01
- [x] 恢复爆炸现场

- [x] 上午尝试一下修 pc2 不正确停止 ✅ 2026-06-02

- [ ] 下午做横向线段. 改了角的端点, 竖向重投影点, 横向用后场边中点
      竖向尝试过用线段端点, 效果不太好

![[attachments/Pasted image 20260602184004.png]]


- [x] 工具显示相机位置, 姿态角 ✅ 2026-06-03

现在是两个明显的问题, 一个是 0409 pc2cam0 不知道为什么算不出一个好的外参, 明明线的检测很准, 另一个是有影子的工况无法正常检测

1 可以让外参像 ps 一样自由变换吗? 将角点拉到对应位置

<section style="display: flex; flex-direction: row; align-items: center;"><span style="color: rgb(75, 153, 211); display: flex; flex-direction: row; align-items: center; padding: 0px 0.5em; font-size: 0.824em; border-radius: 0.428em; line-height: 2.306em; background-color: rgba(75, 153, 211, 0.15);"><span style="margin-right: 0.2em; display: flex; flex-direction: row; align-items: center; justify-content: center;"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 24 24" width="1.9988577955454025em" height="1.9988577955454025em" stroke="currentColor" aria-hidden="true" class=""><path d="m21.15 6.85c0-2.2056-1.7944-4-4-4-4.1765-0.01989-5.4993 5.7322-1.8147 7.5629-0.263 0.63631-0.4627 1.4421-0.6559 2.2215-0.1397 0.56337-0.2841 1.1459-0.4405 1.6084-0.0728 0.2155-0.1286 0.4813-0.1891 0.4813-0.5072-0.7362-0.8126-2.2507-1.0979-3.3161-0.47879-1.5358-0.72936-4.4237-2.8018-4.558-0.77422 7e-5 -1.3844 0.52253-1.8138 1.553-0.55019 1.254-0.75064 3.2421-1.3784 4.4472-0.39648 3e-4 -0.79576 0.0045-1.1877 0.0703-0.67978 0.1073-1.3339 0.4195-1.798 0.9347-0.39707 0.4315-0.6427 0.9874-0.74275 1.5623-0.063545 0.351-0.07691 0.7094-0.07883 1.0654 0.001935 0.4718-0.01324 0.9457 0.027745 1.4163 0.09435 1.151 0.65732 2.1308 1.7281 2.6237 0.43467 0.1975 0.91053 0.2877 1.3854 0.3129 0.40096 0.0215 0.80345 0.0129 1.2048 0.0139 0.6491 2e-4 1.2891-0.0515 1.888-0.3229 0.90042-0.4067 1.4845-1.2039 1.6712-2.1666 0.0761-0.3779 0.09179-0.7654 0.09344-1.15 7.7e-4 -0.2699 0.00148-0.5413-7.8e-4 -0.8111-0.00379-0.4854-0.04143-0.9771-0.19121-1.4414-0.28748-0.9172-0.98053-1.616-1.8964-1.909 0.43984-1.1576 0.66815-2.7594 1.1268-3.8895 0.3537 0.72804 0.57113 1.7669 0.82283 2.7298 0.26567 1.0724 0.5404 2.1814 0.90896 3.0557 0.87204 2.2985 3.1124 2.7586 4.0452 0.392 0.5508-1.2642 0.7508-3.279 1.3828-4.4916 2.1142-0.10339 3.8024-1.8557 3.8024-3.995zm-12.073 8.8023c0.05605 0.2275 0.06623 0.465 0.07092 0.6983 0.00363 0.2444 0.00195 0.4906 0.00214 0.735-0.0063 0.408 0.01486 0.882-0.18359 1.2496-0.24573 0.4539-0.8026 0.501-1.2651 0.5114-0.33714 0.0058-0.67525 0.0041-1.0124 0.0018-0.46455-0.0092-1.0361-0.0245-1.3192-0.4545-0.16612-0.2552-0.19733-0.5702-0.21202-0.8673-0.01004-0.2443-0.00683-0.4906-0.0075-0.735 5.9e-4 -0.2322-0.00201-0.4664 0.01171-0.6983 0.01886-0.2936 0.06332-0.6069 0.24969-0.8453 0.34185-0.4331 1.0226-0.3889 1.5228-0.3979 0.38828 0.0035 0.77905-0.0131 1.1658 0.0285 0.49865 0.0566 0.85211 0.2621 0.97684 0.7737zm8.0732-6.8023c-2.6379-0.06696-2.6373-3.9334 0-4 2.6378 0.06697 2.6373 3.9334 0 4z" fill="currentColor"></path></svg></span>腐蚀和膨胀</span></section>

腐蚀和膨胀是**图像形态学**的基本操作，常用于处理二值图或灰度图。

- **腐蚀(erosion)**：用结构元素扫描图像，仅当结构元素覆盖的所有像素均为前景（白色/亮）时，中心像素才保留为前景，否则变为背景（黑色/暗）。效果是**缩小前景区域、消除细小的亮斑、断开狭窄的连接**。
- **膨胀(dilation)**：与腐蚀相反，只要结构元素覆盖的任一像素为前景，中心像素即变为前景。效果是**扩大前景区域、填补暗孔、连接断裂的边界**。

两者组合可派生出：
- **开运算**（先腐蚀后膨胀）：去除小噪声点，分离物体, 去除较小的物体, 保留较大的对象。
- **闭运算**（先膨胀后腐蚀）：填充小空洞，连接小的断裂。

在灰度图中，腐蚀取邻域最小值（变暗），膨胀取邻域最大值（变亮），用于提取亮/暗特征（如顶帽变换）。

<section style="display: flex; flex-direction: row; align-items: center;"><span style="color: rgb(75, 153, 211); display: flex; flex-direction: row; align-items: center; padding: 0px 0.5em; font-size: 0.824em; border-radius: 0.428em; line-height: 2.306em; background-color: rgba(75, 153, 211, 0.15);"><span style="margin-right: 0.2em; display: flex; flex-direction: row; align-items: center; justify-content: center;"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 24 24" width="1.9988577955454025em" height="1.9988577955454025em" stroke="currentColor" aria-hidden="true" class=""><path d="m21.15 6.85c0-2.2056-1.7944-4-4-4-4.1765-0.01989-5.4993 5.7322-1.8147 7.5629-0.263 0.63631-0.4627 1.4421-0.6559 2.2215-0.1397 0.56337-0.2841 1.1459-0.4405 1.6084-0.0728 0.2155-0.1286 0.4813-0.1891 0.4813-0.5072-0.7362-0.8126-2.2507-1.0979-3.3161-0.47879-1.5358-0.72936-4.4237-2.8018-4.558-0.77422 7e-5 -1.3844 0.52253-1.8138 1.553-0.55019 1.254-0.75064 3.2421-1.3784 4.4472-0.39648 3e-4 -0.79576 0.0045-1.1877 0.0703-0.67978 0.1073-1.3339 0.4195-1.798 0.9347-0.39707 0.4315-0.6427 0.9874-0.74275 1.5623-0.063545 0.351-0.07691 0.7094-0.07883 1.0654 0.001935 0.4718-0.01324 0.9457 0.027745 1.4163 0.09435 1.151 0.65732 2.1308 1.7281 2.6237 0.43467 0.1975 0.91053 0.2877 1.3854 0.3129 0.40096 0.0215 0.80345 0.0129 1.2048 0.0139 0.6491 2e-4 1.2891-0.0515 1.888-0.3229 0.90042-0.4067 1.4845-1.2039 1.6712-2.1666 0.0761-0.3779 0.09179-0.7654 0.09344-1.15 7.7e-4 -0.2699 0.00148-0.5413-7.8e-4 -0.8111-0.00379-0.4854-0.04143-0.9771-0.19121-1.4414-0.28748-0.9172-0.98053-1.616-1.8964-1.909 0.43984-1.1576 0.66815-2.7594 1.1268-3.8895 0.3537 0.72804 0.57113 1.7669 0.82283 2.7298 0.26567 1.0724 0.5404 2.1814 0.90896 3.0557 0.87204 2.2985 3.1124 2.7586 4.0452 0.392 0.5508-1.2642 0.7508-3.279 1.3828-4.4916 2.1142-0.10339 3.8024-1.8557 3.8024-3.995zm-12.073 8.8023c0.05605 0.2275 0.06623 0.465 0.07092 0.6983 0.00363 0.2444 0.00195 0.4906 0.00214 0.735-0.0063 0.408 0.01486 0.882-0.18359 1.2496-0.24573 0.4539-0.8026 0.501-1.2651 0.5114-0.33714 0.0058-0.67525 0.0041-1.0124 0.0018-0.46455-0.0092-1.0361-0.0245-1.3192-0.4545-0.16612-0.2552-0.19733-0.5702-0.21202-0.8673-0.01004-0.2443-0.00683-0.4906-0.0075-0.735 5.9e-4 -0.2322-0.00201-0.4664 0.01171-0.6983 0.01886-0.2936 0.06332-0.6069 0.24969-0.8453 0.34185-0.4331 1.0226-0.3889 1.5228-0.3979 0.38828 0.0035 0.77905-0.0131 1.1658 0.0285 0.49865 0.0566 0.85211 0.2621 0.97684 0.7737zm8.0732-6.8023c-2.6379-0.06696-2.6373-3.9334 0-4 2.6378 0.06697 2.6373 3.9334 0 4z" fill="currentColor"></path></svg></span>LAB颜色空间</span></section>

LAB 颜色空间（全称 CIELAB）是由国际照明委员会（CIE）制定的色彩模型，旨在**模拟人眼视觉感知**，具有**感知均匀性**（颜色数值变化与视觉差异成正比）。
...
- **b***：蓝→黄（负值偏蓝，正值偏黄）
 与 RGB/HSV 的区别
- **RGB/HSV** 基于设备（显示器、相机）或色相/饱和度，**数值变化不反映人眼感知**。
- **LAB** 将颜色分离为**亮度信息（L）**和**色彩信息（a,b）**，且亮度与色度独立，便于光照不敏感的处理。

 常见用途
- **颜色测量**：色差计算（ΔE）唯一标准。
- **图像分割**：基于 a/b 通道的聚类可忽略光照影响。
- **颜色校正**：只调整 L 通道保持色调稳定。
- **工业检测**：识别颜色偏差（如印刷品校色）。
...
// 注意 OpenCV 中 L: 0-255, a: 0-255（需映射），b: 0-255
// 标准 CIELAB 需手动转换，但 OpenCV 内部已做归一化
```

关键特性
- 色域覆盖所有可见光，比 RGB 广。
- **抗光照干扰**：分离亮度和色彩，适合动态光照场景（如机器人视觉、图像增强）。

---

稳定特征: 场地线, 平行关系, 比例关系

- [x] 分离出一个单独函数 ✅ 2026-06-04
- [x] 由于远近导致的粗细变化-> 根据场地斜切成上三角和下三角 ✅ 2026-06-04
...
![[attachments/Pasted image 20260608144158.png]]

gdc_enable_
去畸变在哪个坐标体积, k 和 2d 点就要在哪一级
去畸变在 2688 所以还原全图应该是更合理的
先尝试跑通还原链路
- [x] 相机参数 ✅ 2026-06-09
- [x] 工具参数, 工具0点还原 ✅ 2026-06-09
- [x] 切割链路 ✅ 2026-06-09
- [x] 还原链路 ✅ 2026-06-09

![[attachments/Pasted image 20260609145853.png]]

<section style="display: flex; flex-direction: row; align-items: center;"><span style="color: rgb(75, 153, 211); display: flex; flex-direction: row; align-items: center; padding: 0px 0.5em; font-size: 0.824em; border-radius: 0.428em; line-height: 2.306em; background-color: rgba(75, 153, 211, 0.15);"><span style="margin-right: 0.2em; display: flex; flex-direction: row; align-items: center; justify-content: center;"><svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 24 24" width="1.9988577955454025em" height="1.9988577955454025em" stroke="currentColor" aria-hidden="true" class=""><path d="m21.15 6.85c0-2.2056-1.7944-4-4-4-4.1765-0.01989-5.4993 5.7322-1.8147 7.5629-0.263 0.63631-0.4627 1.4421-0.6559 2.2215-0.1397 0.56337-0.2841 1.1459-0.4405 1.6084-0.0728 0.2155-0.1286 0.4813-0.1891 0.4813-0.5072-0.7362-0.8126-2.2507-1.0979-3.3161-0.47879-1.5358-0.72936-4.4237-2.8018-4.558-0.77422 7e-5 -1.3844 0.52253-1.8138 1.553-0.55019 1.254-0.75064 3.2421-1.3784 4.4472-0.39648 3e-4 -0.79576 0.0045-1.1877 0.0703-0.67978 0.1073-1.3339 0.4195-1.798 0.9347-0.39707 0.4315-0.6427 0.9874-0.74275 1.5623-0.063545 0.351-0.07691 0.7094-0.07883 1.0654 0.001935 0.4718-0.01324 0.9457 0.027745 1.4163 0.09435 1.151 0.65732 2.1308 1.7281 2.6237 0.43467 0.1975 0.91053 0.2877 1.3854 0.3129 0.40096 0.0215 0.80345 0.0129 1.2048 0.0139 0.6491 2e-4 1.2891-0.0515 1.888-0.3229 0.90042-0.4067 1.4845-1.2039 1.6712-2.1666 0.0761-0.3779 0.09179-0.7654 0.09344-1.15 7.7e-4 -0.2699 0.00148-0.5413-7.8e-4 -0.8111-0.00379-0.4854-0.04143-0.9771-0.19121-1.4414-0.28748-0.9172-0.98053-1.616-1.8964-1.909 0.43984-1.1576 0.66815-2.7594 1.1268-3.8895 0.3537 0.72804 0.57113 1.7669 0.82283 2.7298 0.26567 1.0724 0.5404 2.1814 0.90896 3.0557 0.87204 2.2985 3.1124 2.7586 4.0452 0.392 0.5508-1.2642 0.7508-3.279 1.3828-4.4916 2.1142-0.10339 3.8024-1.8557 3.8024-3.995zm-12.073 8.8023c0.05605 0.2275 0.06623 0.465 0.07092 0.6983 0.00363 0.2444 0.00195 0.4906 0.00214 0.735-0.0063 0.408 0.01486 0.882-0.18359 1.2496-0.24573 0.4539-0.8026 0.501-1.2651 0.5114-0.33714 0.0058-0.67525 0.0041-1.0124 0.0018-0.46455-0.0092-1.0361-0.0245-1.3192-0.4545-0.16612-0.2552-0.19733-0.5702-0.21202-0.8673-0.01004-0.2443-0.00683-0.4906-0.0075-0.735 5.9e-4 -0.2322-0.00201-0.4664 0.01171-0.6983 0.01886-0.2936 0.06332-0.6069 0.24969-0.8453 0.34185-0.4331 1.0226-0.3889 1.5228-0.3979 0.38828 0.0035 0.77905-0.0131 1.1658 0.0285 0.49865 0.0566 0.85211 0.2621 0.97684 0.7737zm8.0732-6.8023c-2.6379-0.06696-2.6373-3.9334 0-4 2.6378 0.06697 2.6373 3.9334 0 4z" fill="currentColor"></path></svg></span>Sobel</span></section>

Sobel 是一种梯度算子：在图像上估计 亮度变化有多剧烈、往哪个方向变。
对灰度图每个像素，大致做两件事：
1. 水平 Sobel：左右邻域对比 → 得到 x 方向梯度 `dx`（竖边强）
2. 竖直 Sobel：上下邻域对比 → 得到 y 方向梯度 `dy`（横边强）
合起来得到 梯度幅值（你们代码里用 L1）：
$gradient = |dx| + |dy|$
幅值大 → 这里像“边缘”；幅值小 → 平坦区域。
在 OpenCV 里就是：
```cpp
cv::Sobel(gauss_img, dx, CV_16S, 1, 0, 3, ...); // x 方向
cv::Sobel(gauss_img, dy, CV_16S, 0, 1, 3, ...); // y 方向
```
最后的 `3` 是核大小 3×3。
...
![[attachments/Pasted image 20260611114440.png]]

## week 14

周一调整了远近分区, 缓解竖线被切开的状况

- [ ] crop 自适应调整
- [x] 本帧统计-> 自适应参数 ✅ 2026-06-16
...
|#|事项|说明|
|---|---|---|
|1|实现 `process_lines_pts2` 主入口|串起：`preprocess_line_segments` → `group_line_bundles` → `build_court_pentagon_frame` → `build_template_line_model` → `match_court_topology` → `assign_court_line_endpoints` → `infer_missing_court_lines` → `compute_court_pts_ordered` → `court_slots_to_court_lines` → `check_pattern2`|
|2|`test_single_image_detect` 切到新管线|可配置走 `process_lines_pts` / `process_lines_pts2`，便于对比|
|3|Snapshot 输出槽位诊断|写入 `CourtLineSlot`（index / status / confidence / matched_bundle_idx / centerline），脏场地+邻场图优先跑|
|4|用问题图做「槽位诊断表」|记录：缺 H0/H1？哪根 V 错位？bundle 数是否 >7？邻场线是否进 bundle？——后续所有预处理/后处理改动都对准这张表|
...
|#|事项|说明|
|---|---|---|
|5|邻场干扰|pentagon ROI、竖线 bundle 滑动窗口 + 拓扑 cost 拒错束；针对「旁边近场场地」 case|
|6|远场断线 / 脏 H|若拓扑显示 H0 Missing 但 far edge 有碎段 → 调 far 召回或 bundle 合并；若完全无 edge → 再动 far morph/Canny|
|7|`compute_intersection` 加 `const`|若 `build_court_pentagon_frame` 编译仍有问题|
|8|远场竖线角度门槛|cam2 远端近 0° 被 `is_court_line_angle` 拒掉的问题（可选放宽）|

---

P2 — 预处理 / Adaptive（后处理有反馈后再闭环）

|#|事项|说明|
|---|---|---|
|9|Adaptive 慢环接拓扑|例：连续 N 帧 `H0=Missing` 且 `far_cur_stat.signal_ratio` 不低 → 降 `far_faint_ratio` / `far_canny_min_ratio`；连续拓扑 cost 高 + 近场 `noise_score` 高 → 略升 `near_*` 严滤|
|10|CLAHE / blackhat 开关|yaml 或 `AdaptiveInfo` 控制；blackhat 分区（远/近已有 beta，可扩展到 0=关）|
|11|blackhat 自动回退|关 blackhat 后若拓扑 Missing 增多或 bundle 数爆炸 → 自动恢复；需记录：近场杂线是主要风险，远场需单独指标|
|12|`filter_faint` 改 p95|用分位数替代 `max×ratio`，减少单点噪点拉阈值（可选）|
|13|debug 连续录像|10 帧不够看 EMA；录一段 + 打 `adaptive_info_` / 槽位状态曲线|
...
|#|事项|说明|
|---|---|---|
|14|旧 `cluster_lines` 横线聚类|已决定不改；新管线替代|
|15|`pre_process2_design.md` 同步|主轴指标、adaptive、懒加载 mask、blackhat 分区等|
|16|filter 方案 2（inlier 写回）|杂枝连通导致 elongation 误判；可选|

---

建议执行顺序（一句话）

process_lines_pts2 + snapshot 槽位

→ 脏场地/邻场图诊断

→ 针对性改拓扑/ROI/bundle

→ 再开 adaptive / CLAHE / blackhat 开关 + 自动回退

---

暂不做 / 已搁置

- 旧流程 `cluster_lines` ymax / shrink 修复
- 实心线 morph（双边缘可交给 bundle）
- 多尺度 tophat 加核（耗时）
- 单帧万能预处理参数
...
- [x] 跳过转 BGR 直接使用 YUV ✅ 2026-06-23
- [x] 从模板构建槽位 roi+mask ✅ 2026-06-23
- [ ] 使用上一帧的线色彩色度抠图
- [x] 单线 Morph ✅ 2026-06-24
- [x] 单线追脊 ✅ 2026-06-24
- [x] 追 ribbon ✅ 2026-06-25
- [ ] prior_cost, dvmax, lambda_smooth 尚不合理, 扩带的 thresh
- [x] 得到 ridge_path 后分段拟合 ✅ 2026-06-25
- [ ] 剪枝: 如果 roi 内根本没有线( y 很平均) 可以提前结束这一帧这一条/这一法向的检测
- [ ] roi 自动调整
- [ ] 拓扑匹配
- [ ] 模板线yml加载
- [x] 改 init ✅ 2026-06-26
- [ ] 冷启动确定 roi
- [ ] match topo
- [x] 调 morph, gap ✅ 2026-06-29
- [ ] ridge 偏上了一点点
- [ ] roi 线向边界修正
mask 在可视化里会超出去, 实际上是不会超出 cv::Mat 的
- [ ] 单横 vtop 有问题

https://sdk.d-robotics.cc/sdk_release/user_manual/LNX6.1.83_PL5.1_V1.1.0/quick_start/update_system_firmware.html
...
sudo timedatectl set-time '2026-07-09 11:24:00'
```
